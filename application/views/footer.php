...
<div class="row col-lg-12">
 <div class="row col-lg-2 col-md-3 col-sm-3 col-xs-12">
   <img src="<?php echo base_url('/images/pclogo (2).png');?>" style="height:inherit;" class="img-responsive"/>
 </div> 
<div class="row col-lg-1 col-sm-3">
    &nbsp;
  </div>
 ...
 <div class="row col-lg-3 col-md-3 col-sm-6 col-xs-12">
  ...
  <p class="size">*Important Disclosure:&nbsp;<a href="' .site_url("Home").'">PropChunk.com</a>&nbsp;is a website operated by CHUNK TECHNOLOGIES PVT. LTD. and by accessing the website and any pages thereof, you agree to be bound by its&nbsp;<a href="' .site_url("Home/terms").'" >Terms of Service</a>&nbsp;and&nbsp;<a href="'. site_url("Home/privacy-policy").'" >Privacy Policy</a>. CHUNK TECHNOLOGIES PVT. LTD. and its platform PropChunk operate in Maharashtra and are registered with the Registrar Of Companies, Maharashtra.</p>
...
<div class="col-lg-12" style="padding:0px">
<a href="<?= site_url("Home/terms") ?>" >Terms of Service</a>&nbsp;|&nbsp;<a href="<?= site_url("Home/privacy-policy") ?>" >Privacy Policy</a>  
	<!-- /Section: contact -->
</div>
</div>	
